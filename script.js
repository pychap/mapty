...
// "we will never create a workout object, only running & cycling obj's"
class Workout {
  date = new Date();
  // creating IDs is a "very important part of any application"
...
class App {
  ...
  // render workout on list as a marker *
